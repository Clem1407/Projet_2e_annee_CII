...
class rect:
    ...
    def fenetre(self):
        ...
        Jouer_button = Button(frame, text="Jouer au jeu ", font=("Elephant", 30), bg='#093a87', fg='white',
                              command=choix)
    ...
    def fen(self):
        ...
        label_title3.pack()
        Rejouer = Button(frame3, text='''Rejouer''', font=("Bahnschrift", 30), bg='#09234d', fg='white')
        Rejouer.pack(expand="yes")

        Retour = Button(frame3, text='''Retour''', font=("Bahnschrift", 15), bg='black', fg='white',
                        command=frame3.destroy)
